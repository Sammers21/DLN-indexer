...
import { calculateUsdValue, decodeAmountBytes, getTokenDecimals } from "../src/price";
...
describe("Price utilities", () => {
    ...
    it("returns known token decimals without RPC lookup", async () => {
        const decimals = await getTokenDecimals("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
